        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-1">
            {['Privacy', 'Terms', 'Contact'].map((l) => (
              <span key={l} className="font-mono text-[10px] text-bone/25 hover:text-lime/60 px-3 py-1.5 rounded-lg hover:bg-lime/[0.04] cursor-pointer transition-all duration-200 tracking-wider">{l}</span>
            ))}
          </div>
        </div>

        <div className="mt-6 pt-5 border-t border-bone/[0.04] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-mono text-[10px] text-bone/12 tracking-wider">&copy; 2026 Limit U</p>

          <div className="flex items-center gap-5">
            <a href="mailto:team.limitu@gmail.com" className="flex items-center gap-1.5 group">
              <svg className="w-3 h-3 text-bone/20 group-hover:text-lime/50 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0l-9.75 6.75L2.25 6.75" /></svg>
              <span className="font-mono text-[10px] text-bone/20 group-hover:text-bone/45 transition-colors tracking-wider">team.limitu@gmail.com</span>
            </a>
            <a href="tel:+919475565982" className="flex items-center gap-1.5 group">
              ...
              <span className="font-mono text-[10px] text-bone/20 group-hover:text-bone/45 transition-colors tracking-wider">+91 94755 65982</span>
            </a>
          </div>
        </div>
      </div>
